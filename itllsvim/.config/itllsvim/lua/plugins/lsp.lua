      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
            local highlight_augroup = vim.api.nvim_create_augroup("mynvim-lsp-highlight", { clear = false })
            ...
            vim.api.nvim_create_autocmd("LspDetach", {
              group = vim.api.nvim_create_augroup("mynvim-lsp-detach", { clear = true }),
              callback = function(event2)
                vim.lsp.buf.clear_references()
                vim.api.nvim_clear_autocmds({ group = "mynvim-lsp-highlight", buffer = event2.buf })
              end,
            })
          end
